    ...
    if (verified) {
      await resend.emails.send({
        ...
        html: '<div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 2rem;">' +
          ...
          '<p style="color: #6e6e73; font-size: 14px; line-height: 1.6; margin-bottom: 1.5rem;">Hi ' + builder_name + ' — your ShipStacked profile has been reviewed and verified. Your profile now carries the verified badge, making you more visible to hirers.</p>' +
