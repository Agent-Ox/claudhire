...
export async function POST(req: Request) {
  ...
  try {
    await resend.emails.send({
      ...
      to: email,
      subject: 'Your ClaudHire profile is live 🎉',
      html: `
        <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 2rem;">
          <h1 style="font-size: 24px; font-weight: 700; color: #1d1d1f; letter-spacing: -0.02em;">You're live on ClaudHire.</h1>
...
for Claude-native talent.</p>
          <a href="https://claudhire.com/u/${username}" 
