  ...
  return (
    <div style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div style={{ background: 'white', border: '1px solid #e0e0e5', borderRadius: 16, padding: '1.5rem' }}>
        ...
        <a href="/hirers" style={{ display: 'inline-block', padding: '0.7rem 1.25rem', background: '#1d1d1f', color: 'white', borderRadius: 980, fontSize: 14, fontWeight: 500, textDecoration: 'none' }}>See hirer plans</a>
      </div>
